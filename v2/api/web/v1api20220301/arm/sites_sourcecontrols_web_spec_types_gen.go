...
type SitesSourcecontrolsWeb_Spec struct {
	...
	Properties *Sites_Sourcecontrols_Web_Properties_Spec `json:"properties,omitempty"`
}

var _ genruntime.ARMResourceSpec = &SitesSourcecontrolsWeb_Spec{}

// GetAPIVersion returns the ARM API version of the resource. This is always "2022-03-01"
func (sourcecontrolsWeb SitesSourcecontrolsWeb_Spec) GetAPIVersion() string {
	return "2022-03-01"
}

// GetName returns the Name of the resource
func (sourcecontrolsWeb *SitesSourcecontrolsWeb_Spec) GetName() string {
	return sourcecontrolsWeb.Name
}

// GetType returns the ARM Type of the resource. This is always "Microsoft.Web/sites/sourcecontrols/web"
func (sourcecontrolsWeb *SitesSourcecontrolsWeb_Spec) GetType() string {
	return "Microsoft.Web/sites/sourcecontrols/web"
}

type Sites_Sourcecontrols_Web_Properties_Spec struct {
